...
@register_model
def fastvithd(pretrained=False, inference_mode=False, **kwargs):
    """Instantiate FastViTHD model variant.

    Args:
        pretrained: Not implemented.
        inference_mode: If False (default), model can load non-reparametrized weights.
                       If True, model is in inference mode with reparametrized weights.
    """
    layers = [2, 12, 24, 4, 2]
